...
def attach_attibute(mesh, result_dir, tar_dir, n, step, unit_size, prefix, shift):   # shift = 22
    '''
    mesh: the address the ArcGIS .shp file of OpenFOAM mesh stored in
    result_dir: the address OpenFOAM simulation result stored in
    tar_dir: the address pictures generated by this function stored in
